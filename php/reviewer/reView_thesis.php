...
$sql = "SELECT * FROM repoTable WHERE JSON_CONTAINS(reviewer_id, '\"$reviewer_id\"') AND status = 'Pending' AND (Chapter = '1' or Chapter = '2' or Chapter = '3' or Chapter = '4' ORDER BY id DESC)";
