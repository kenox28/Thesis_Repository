...
<body>
    ...
    <!-- Enhanced Modal for thesis details -->
    <div id="thesisModal" class="modal" style="display:none;">
        <div class="modal-content large-modal enhanced-modal">
            ...
            <div class="modal-body">
                ...
                <iframe id="modalPDF" src="" width="100%" height="100%" style="border-radius:12px;box-shadow:0 2px 12px #1976a522;margin-top:18px;border:2px solid #e9f0ff;"></iframe>
            </div>
        </div>
    </div>
</body>
